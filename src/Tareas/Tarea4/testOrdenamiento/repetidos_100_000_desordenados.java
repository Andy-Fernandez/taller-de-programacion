...
public class repetidos_100_000_desordenados {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner lee = new Scanner(new File(Ordenamientos.class.getResource("datos/repetidos-100_000/datos1_Desordenados.txt").getPath()));
        System.out.println("DATOS DESORDENADOS - 100.000 REPETIDOS");
        // CARGANDO LOS DATOS
        int n = lee.nextInt();
