...
public class diferentes_10_000_ordenados {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner lee = new Scanner(new File(Ordenamientos.class.getResource("datos/diferentes-10_000/datos4_Ordenados.txt").getPath()));
        System.out.println("DATOS ORDENADOS - 10.000 DIFERENTES");
        // CARGANDO LOS DATOS
        int n = lee.nextInt();
